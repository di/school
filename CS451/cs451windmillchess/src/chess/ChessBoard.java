...
public class ChessBoard extends JFrame implements MouseListener, MouseMotionListener
{
	...
	{
		ImageIcon tmp = new ImageIcon(new ImageIcon(path).getImage().getScaledInstance(boardSize.height / NUMBER_OF_RANKS, boardSize.width / NUMBER_OF_FILES, java.awt.Image.SCALE_SMOOTH));
		return tmp;
	}
