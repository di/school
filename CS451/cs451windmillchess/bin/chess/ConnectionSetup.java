...
public class ConnectionSetup implements ActionListener, KeyListener
{
	...
	public void throwErrorWindow()
	{
		JOptionPane.showMessageDialog(null, "Invalid IP and/or Port Number!", "Error!", JOptionPane.ERROR_MESSAGE);
	}
	...
	public void attemptConnection()
	{
		...
		if (connect)
		{
			...
			if (validateIP(ipField.getText()) && validatePort(portField.getText()))
			{
				...
				{
					JOptionPane.showMessageDialog(null, "Unable to connect.  Connection refused.", "Error!", JOptionPane.ERROR_MESSAGE);
				}
			}
			else
				throwErrorWindow();
		...
		else
		{
			if (validatePort(portField.getText()))
			{
				...
				{
					JOptionPane.showMessageDialog(null, "Could not bind to port.", "Error!", JOptionPane.ERROR_MESSAGE);
				}
			}
			else
				throwErrorWindow();
