...
public class PacMan extends SimState
    ...
    public void resetAgents()
        ...
        pacs = new RandomPac[1];  // set this to Pac[1] to make this one-player
        ...
        // add Pinky
        Blinky pinky = new Blinky(this);

        // add Inky
        Blinky inky = new Blinky(this);

        // add Clyde
        Blinky clyde = new Blinky(this);
        
        // add the RandomPac
        pacs[0] = new RandomPac(this,  blinky, pinky, inky, clyde);
