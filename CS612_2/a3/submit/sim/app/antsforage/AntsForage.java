...
public /*strictfp*/ class AntsForage extends SimState
    ...
    public double evaporationConstant = Math.round(new Random().nextFloat()*100.0)/100.0;
    ...
    public void start()
        ...
        if (state.schedule.getSteps() > 3000) {
            System.out.println("{'evap':" + evaporationConstant + ",'foods':" + state.foodCount + "}");
            state.finish();
            System.exit(1);
        }
