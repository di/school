...
env = Environment({}, {}, "ral.txt", "mem.txt")
...
def p_program( p ) :
  ...
  P.write("trans.txt")
  env.compiler.link()
  env.compiler.write_ins("ral.txt")
  env.compiler.optimize()
  env.compiler.write_ins("ral-op.txt")
  env.compiler.write_mem("mem.txt")
#  P.eval()
  P.dump()
...
def main() :
	...
	for o, a in opts:
		if o == "-O" :
			env.compiler.enable_optimization()
